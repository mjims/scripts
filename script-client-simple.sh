...
echo
echo "=== FICHIERS CERTIFICAT ==="
echo "${OVPN_DIR}/${CLIENT}.crt"
echo "${OVPN_DIR}/${CLIENT}.key"
echo "${OVPN_DIR}/${CLIENT}-ca.crt"
echo
echo "=== SCRIPT MIKROTIK ==="

cat <<EOF
/certificate import file-name="${CLIENT}-ca.crt" passphrase=""
